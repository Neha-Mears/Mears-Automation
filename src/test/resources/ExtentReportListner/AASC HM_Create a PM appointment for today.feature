...
@150655_AASC_HM_Create_a_PM_appointment_for_today
Feature: TC_150655:AASC HM_Create a PM appointment for today
  ...
  Scenario Outline: AASC HM_Create a PM appointment for today
    ...
    #  | MCMViewHMUsername | MCMAppUserPassword | Portal      | SSSA10 DA  , DA STREET,  Gloucester,  Gloucestershire,  England,  GL13NN | 16:00:00      | New Appointment Sent to Mears Enable | The appointment was successfully sent to Mears Enable. |
      | RLAPMearsuser | RLAPMearspassword | Portal      | SSSA10 DA  , DA STREET,  Gloucester,  Gloucestershire,  England,  GL13NN | 15:00:00      | New Appointment Sent to Mears Enable | The appointment was successfully sent to Mears Enable. |
