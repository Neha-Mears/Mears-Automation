...
Feature: TC_146193:AASC HM and RLAP_Mears | Can edit an existing incident raised against Other and set it to Monitoring
 ...
 @TC146193_166006_AASC_HM_and_RLAP_Mears_Can_edit_an_existing_incident_raised_against_Other_and_set_it_to_Monitoring
  Scenario Outline: AASC HM and RLAP_Mears| Can edit an existing incident raised against Other and set it to Monitoring
    ...
    And user click on "Status" the Drop Down List
    And user select "<Status_update>" from dropdown
    Then user click on save button
   ...
   ## And user take the screenshot for confirmation page
    ...
    Examples: 
      | username          | password           | serviceName | address                                                                  | text                              | message                                                          | setmonth | setyear | setDate | success_msg                  | Status_update |
     # | MCMViewHMUsername | MCMAppUserPassword | Portal      | SSSA10 DA  , DA STREET,  Gloucester,  Gloucestershire,  England,  GL13NN | Complaint Status Set to Complete. | Please ensure you have specified an outcome and a resolved date. | August   |    2023 |      25 | The operation was successful | Monitoring    |
      | RLAPMearsuser     | RLAPMearspassword  | Portal      | SSSA10 DA  , DA STREET,  Gloucester,  Gloucestershire,  England,  GL13NN | Complaint Status Set to Complete. | Please ensure you have specified an outcome and a resolved date. | August   |    2023 |      29 | The operation was successful | Monitoring    |
