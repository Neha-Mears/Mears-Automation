...
@TC164833_165331_165900_RLAP_Mears_Can_edit_an_existing_incident_raised_by_SU_and_set_it_to_Complete
Feature: TC_164833_165331:  RLAP Mears_Can edit an existing incident raised by SU and set it to Complete

  Background: 
    Given User Navigate to MCMView App

  @TC164833_165331_165900_RLAP_Mears_Can_edit_an_existing_incident_raised_by_SU_and_set_it_to_Complete
  Scenario Outline: RLAP Mears_Can edit an existing incident raised by SU and set it to Complete
    ...
    And user take the screenshot for confirmation page for Test case "TC_164833_165331_165900"

    Examples: 
      | username      | password          | serviceName | address                                      | text                               | message                                                          | setmonth | setyear | setDate | success_msg                  |
      | RLAPMearsuser | RLAPMearspassword | Portal      | Room 3, 1 Agincourt Avenue, Belfast, BT7 1QA | Incident Status Set to Completed.. | Please ensure you have specified an outcome and a resolved date. | October  |    2023 |       4 | The operation was successful |
