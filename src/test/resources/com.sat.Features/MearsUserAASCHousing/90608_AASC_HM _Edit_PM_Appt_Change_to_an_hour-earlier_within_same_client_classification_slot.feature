...
Feature: TC_90608: AASC HM -Edit PM Appt - Change to an hour earlier within same client classification slot
  ...
  Scenario Outline: AASC HM -Edit PM Appt - Change to an hour earlier within same client classification slot
    ...
    #####################pre-condition over################################
    Then user click on the same client classification slot "<availableslot>"
    ...
    Examples: 
      ...
      #  | MCMViewHMUsername | MCMAppUserPassword | Portal      | SSSA10 DA  , DA STREET,  Gloucester,  Gloucestershire,  England,  GL13NN | 15:00:00      |         12 |       14 | New Appointment Sent to Mears Enable | Updated Appointment Sent to Mears Enable | The appointment was successfully sent to Mears Enable. |  |
      | RLAPMearsuser | RLAPMearspassword | Portal      | SSSA10 DA  , DA STREET,  Gloucester,  Gloucestershire,  England,  GL13NN | 15:00:00      |         14 |       15 | New Appointment Sent to Mears Enable | Updated Appointment Sent to Mears Enable | The appointment was successfully sent to Mears Enable. |  |
