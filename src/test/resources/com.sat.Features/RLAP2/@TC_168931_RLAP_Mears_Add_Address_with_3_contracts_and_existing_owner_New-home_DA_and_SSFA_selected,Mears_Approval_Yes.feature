...
@TC_168931_RLAP_Mears_Add_Address_with_3_contracts_and_existing_owner_New-home_DA_and_SSFA_selected,Mears_Approval_Yes
Feature: Testing of RLAP Mears keys tap
  ...
  Scenario: Living HO_ Edit key log - Add and edit notes
    ...
    Then I click on "3" checkbox for Contract Name
    Then Click on "stepper-buttons__wrapper" the "Next" button in Add Property
    Then user fill details for "Room / Building" as "1203"
    ...
    Then user fill details for "Rent" as "1400"
    ...
    When user search "1203,  Exeter" and "1203,  Exeter,  Devon,  England,  EX1 3UT" click on the address details for new version
