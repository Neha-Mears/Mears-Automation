...
Feature: Testing of RLAP Mears keys tap
  ...
  Scenario: Living HO_ Edit key log - Add and edit notes
    ...
    Then user fill details for "Room / Building" as "1288"
    ...
    When user search "1288,  Exeter" and "1288,  Exeter,  Devon,  England,  EX1 3UT" click on the address details for new version
